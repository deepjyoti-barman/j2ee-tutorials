...
/**
 * It is built to demonstrate handling the request of accessing an invalid entry (through SQL query) of a table in given MySQL database.
 * 
 * @author Deepjyoti Barman
 * @since March 02, 2020
 */
public class DQL_SelectAnInvalidEntryStatement
{
    ...
    // Query to be executed (with invalid emp_id)
    static final String MYSQL_QUERY = "SELECT * FROM emp WHERE emp_id = 100";
